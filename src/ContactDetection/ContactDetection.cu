...
std::vector<PotentialContact> ContactDetection::findPotentialContacts(std::vector<Particle>& points)
{
...
void ContactDetection::checkContactsInLeaf(
    const QuadTree* leaf,
...
void ContactDetection::checkContactsBetweenLeaves(
...
bool ContactDetection::areNeighboringNodes(const QuadTree* nodeA, const QuadTree* nodeB)
{
